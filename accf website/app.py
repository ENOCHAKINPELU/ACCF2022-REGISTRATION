...
def register():
    if request.method == "POST":
        ...
        if user:
            ...
            details = Registration(fn=firstname,ln=lastname,email=_email,location=_location,ministration=_ministration,fellowship=_fellowship,phonenumber=phoneno,unit=_unit,gender=_gender,filename=file.filename, img=file.read())
